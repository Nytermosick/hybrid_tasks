...
register_mjlab_task(
  task_id="G1-QP-WITH_ACC_Walk-Flat",
  env_cfg=g1_qp_with_acc_walk_flat_env_cfg(),
  play_env_cfg=g1_qp_with_acc_walk_flat_env_cfg(play=True),
  rl_cfg=g1_qp_with_acc_ppo_runner_cfg(),
  runner_cls=VelocityOnPolicyRunner,
)
